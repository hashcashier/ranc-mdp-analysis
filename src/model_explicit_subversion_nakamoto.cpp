...
shared_ptr<SparseMDP> constructSparseNakamotoSubversionMDP(LD alpha, LD gamma, UI32 T, UI32 S, LD D, UI32 valuationLevel, bool withChoiceLabels) {
...
//            buff << "ADOPT" << endl;
            ...
            State outcome_2 = appendBlock(initialState, true, 0, gamma, false, false, false, false);
//            outcome_2.printToLine(buff);
            ...
            State outcome_3 = appendBlock(initialState, false, 0, gamma, false, false, false, false);
...
//            buff << "OVERRIDE -> " << endl;
            LD Vds = h < S
                     ...
                     : (h + 1 - S) * D;
            LD ra = (h+1) + Vds;
            State postOverride = confirmBlocks(h + 1, tailTimes, state, 0);
//            postOverride.printToLine(buff);
            // outcome 2: next block arrival is for adversary
            State outcome_2 = appendBlock(postOverride, true, 0, gamma, false, false, false, false);
//            outcome_2.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
                    ...
                    stateIndexMap);
            // outcome 3: next block arrival is for the honest miners
            State outcome_3 = appendBlock(postOverride, false, 0, gamma, false, false, false, false);
//            outcome_3.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
...
//            buff << "WAIT" << endl;
            if (f != 2) { // unmatched
                // outcome 2: next block arrival is for adversary
                State outcome_2 = appendBlock(state, true, 0, gamma, false, false, false, false);
//                outcome_2.printToLine(buff);
                addRewardedTransition(
                        choices,
                        rewardedChoiceTransitions,
                        ...
                        stateIndexMap);
                // outcome 3: next block arrival is for the honest miners
                State outcome_3 = appendBlock(state, false, 0, gamma, false, false, false, false);
//                outcome_3.printToLine(buff);
                addRewardedTransition(
                        choices,
                        rewardedChoiceTransitions,
...
//            buff << "MATCH -> ";
            ...
            State postMatch = confirmBlocks(h, tailTimes, state, 0, true);
//            postMatch.printToLine(buff);
            // outcome 1: next block arrival is for adversary
            State outcome_1 = appendBlock(state, true, 0, gamma, true, false, false, false);
//            outcome_1.printToLine(buff);
            ...
            State outcome_2 = appendBlock(state, false, 0, gamma, true, false, false, false);
//            outcome_2.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
            ...
            State outcome_3 = appendBlock(postMatch, false, 0, gamma, false, false, false, false);
//            outcome_3.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
