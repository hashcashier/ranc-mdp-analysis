...
shared_ptr<SparseMDP> constructSparseNakamotoCensorshipMDP(LD alpha, LD gamma, UI32 T, UI32 valuationLevel, bool withChoiceLabels) {
...
//            buff << "ADOPT" << endl;
            ...
            State outcome_2 = appendBlock(initialState, true, 0, gamma, false, false, false);
//            outcome_2.printToLine(buff);
            ...
            State outcome_3 = appendBlock(initialState, false, 0, gamma, false, false, false);
...
//            postOverride.printToLine(buff);
            // outcome 2: next block arrival is for adversary
            State outcome_2 = appendBlock(postOverride, true, 0, gamma, false, false, false);
//            outcome_2.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
                    ...
                    stateIndexMap);
            // outcome 3: next block arrival is for the honest miners
            State outcome_3 = appendBlock(postOverride, false, 0, gamma, false, false, false);
//            outcome_3.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
...
//            buff << "WAIT" << endl;
            if (f != 2) { // unmatched
                // outcome 2: next block arrival is for adversary
                State outcome_2 = appendBlock(state, true, 0, gamma, false, false, false);
//                outcome_2.printToLine(buff);
                addRewardedTransition(
                        choices,
                        rewardedChoiceTransitions,
                        ...
                        stateIndexMap);
                // outcome 3: next block arrival is for the honest miners
                State outcome_3 = appendBlock(state, false, 0, gamma, false, false, false);
//                outcome_3.printToLine(buff);
                addRewardedTransition(
                        choices,
                        rewardedChoiceTransitions,
...
//            postMatch.printToLine(buff);
            ...
            State outcome_1 = appendBlock(state, true, 0, gamma, true, false, false);
//            outcome_1.printToLine(buff);
            ...
            State outcome_2 = appendBlock(state, false, 0, gamma, true, false, false);
//            outcome_2.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
            ...
            State outcome_3 = appendBlock(postMatch, false, 0, gamma, false, false, false);
//            outcome_3.printToLine(buff);
            addRewardedTransition(
                    choices,
                    rewardedChoiceTransitions,
